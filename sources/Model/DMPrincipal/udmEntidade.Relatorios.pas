...
begin
  ...
  begin
    ppLabel35.Caption := 'Conjunto Markup com Alíquota';
...
begin
  ...
  begin
    ppLabel24.Caption := 'Listagem Nome Alíquota';
...
begin
  ...
  begin
    ppListagemFichaTecnica.Caption := 'Listagem Ficha Técnica';
...
begin
  ...
  begin
    ppListagemProducao.Caption := 'Listagem Produção';
