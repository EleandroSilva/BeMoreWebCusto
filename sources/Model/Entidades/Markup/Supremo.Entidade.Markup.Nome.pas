...
function TMarkupNome.Aliquota1(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota1 := aValue;
end;

function TMarkupNome.Aliquota2(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota2 := aValue;
end;

function TMarkupNome.Aliquota3(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota3 := aValue;
end;

function TMarkupNome.Aliquota4(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota4 := aValue;
end;
...
begin
  ...
  if FTextoFiltro <> '' then
    case FEscolhaFiltro of
      ...
      1: lWhere := lWhere + ('and mn.IdRegiao=' +IntToStr(StrToInt(aValue)) + ' ');
      2: lWhere := lWhere + ('and mn.Descricao CONTAINING ''' + aValue + ''' ');
      3: lWhere := lWhere + ('and re.Descricao CONTAINING ''' + aValue + ''' ');
      4: lWhere := lWhere + ('and mn.Operador CONTAINING ''' + aValue + ''' ');
    end;
