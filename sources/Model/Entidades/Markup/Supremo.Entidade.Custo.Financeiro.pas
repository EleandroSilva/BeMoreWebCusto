...
function TCustoFinanceiro.Aliquota1(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota1 := aValue;
end;

function TCustoFinanceiro.Aliquota2(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota2 := aValue;
end;

function TCustoFinanceiro.Aliquota3(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota3 := aValue;
end;

function TCustoFinanceiro.Aliquota4(aValue : Currency) : iModelEntidade;
begin
  Result := Self;
  FAliquota4 := aValue;
end;
...
const
  cSQL = (
          ...
          'PagamentoNome, '+
          'PrazoMedio, '+
          'cast(IndiceFinanceiro*PrazoMedio as numeric(10,3)) JurosFinanceiro, '+
          'Operador, '+
          'DataLancamento, '+
          'Status, '+
          'Ativo ' +
          ...
          'cast(pgto.TT_Dias/pgto.Qtde_Pgto as numeric(10,3)) PrazoMedio, '+
          'cf.Operador, '+
          'cf.DataLancamento, '+
          'cf.Status, '+
          'cf.Ativo '+
...
begin
  Result := Self;
  FQuery.ExecSQL('delete from CustoFinanceiro ');
end;
