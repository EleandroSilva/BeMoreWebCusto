...
const
  cSQL = (
         'select '+
         'coalesce(cast(sum(rd.receita) as numeric (10,3)),0) Receita, '+
         'coalesce(cast(sum(rd.despesa) as numeric (10,3)),0) Despesa, '+
         'coalesce(cast(sum(rd.despesa/rd.receita*100) as numeric (10,3)),0) MargemDepesa '+
