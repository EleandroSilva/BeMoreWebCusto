...
begin
  ...
  FSQL := ('select ' +
           ...
           '   coalesce(cast(sum(lp.somaritem) as numeric(10,3)),0) ValorVendido, ' +
           '   coalesce(cast(sum(lp.somarvalorcustomarkup) as numeric(10,3)),0) ValorCusto, ' +
           '   coalesce(cast(sum(lp.somarvalorlucroreal) as numeric(10,3)),0) LucroPrejuizo ' +
           'from LucroPedido lp '+
