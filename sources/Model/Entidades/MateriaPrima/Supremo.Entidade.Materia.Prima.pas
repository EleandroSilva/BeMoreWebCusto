...
function TMateriaPrima.Aliquota1(aValue: Currency): iModelEntidade;
begin
  Result := Self;
  FAliquota1 := aValue;
end;

function TMateriaPrima.Aliquota2(aValue: Currency): iModelEntidade;
begin
  Result := Self;
  FAliquota2 := aValue;
end;

function TMateriaPrima.Aliquota3(aValue: Currency): iModelEntidade;
begin
  Result := Self;
  FAliquota3 := aValue;
end;

function TMateriaPrima.Aliquota4(aValue: Currency): iModelEntidade;
begin
  Result := Self;
  FAliquota4 := aValue;
end;
