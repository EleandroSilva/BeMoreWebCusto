...
type
  TEntidadeConfig = Class
    private
     ...
     procedure SetIdPedidoLucro            (const Value: Integer);
   ...
   public
     ...
     property IdPedidoLucro      : Integer read FIdPedidoLucro write SetIdPedidoLucro;
     ...
     procedure SalvarUltimoIdPedido;
  End;
...
begin
  FDiretorio := (ExtractFilePath(Application.ExeName));
  FArquivoIni := tIniFile.Create(FDiretorio + 'IdPedidoLucro.Ini');
  try
    SetIdPedidoLucro(FArquivoIni.ReadInteger('Informacao', 'IdPedidoLucro', FIdPedidoLucro));
    SetChamarFormLucroPedido(FArquivoIni.ReadInteger('Informacao', 'ChamarFormLucroPedido', FChamarFormLucroPedido));
  finally
    FArquivoIni.Free;
  end;
end;
...
procedure TEntidadeConfig.SalvarUltimoIdPedido;
begin
  FDiretorio:=(ExtractFilePath(Application.ExeName));
  FArquivoIni := TIniFile.Create(FDiretorio + 'IdPedidoLucro.ini');
  try
    FArquivoIni.WriteInteger('Informacao', 'IdPedidoLucro', FIdPedidoLucro);
    FArquivoIni.WriteInteger('Informacao', 'ChamarFormLucroPedido', FChamarFormLucroPedido);
  finally
    FArquivoIni.Free;
  end;
end;

procedure TEntidadeConfig.SetChamarFormLucroPedido(const Value: Integer);
begin
...
procedure TEntidadeConfig.SetIdPedidoLucro(const Value: Integer);
begin
  FIdPedidoLucro := Value;
end;
