...
function TModel.ValorLancamento3(aValue: Currency): iModelEntidade;
begin
  Result := Self;
  FValorLancamento3 := aValue;
end;

function TModel.ValorLancamento4(aValue: Currency): iModelEntidade;
begin
  Result := Self;
...
function TModel.Aliquota1(aValue: Currency): iModelEntidade;
begin
  Result := Self;
  FAliquota1 := aValue;
end;

function TModel.Aliquota2(aValue : Currency) : iModelEntidade;
begin
  Result := self;
  FAliquota2 := aValue;
end;

function TModel.Aliquota3(aValue : Currency) : iModelEntidade;
begin
  Result := self;
  FAliquota3 := aValue;
end;

function TModel.Aliquota4(aValue : Currency) : iModelEntidade;
begin
  Result := self;
  FAliquota4 := aValue;
end;
...
function TModel.Append : iModelEntidade;
begin
  Result := Self;
  FQuery.Append('');
end;
