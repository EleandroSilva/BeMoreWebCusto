...
begin
  ...
  Try
    ...
    ShowMessage('Ficha técnica atualizada com sucesso!');
    dmPrincipal.cdsFichaTecnica.First;
    btnSearch.Click;
  End;
end;
...
begin
  ...
  begin
    ...
    dmPrincipal.cdsFichaTecnicaItem.FieldByName('ValorUnitario').AsCurrency := dsAuxiliar.DataSet.FieldByName('Vl_Liquido').AsCurrency;
...
begin
  ...
  if dmPrincipal.cdsFichaTecnicaItem.State in [dsEdit] then
    btnAlterarMateriaPrima.SetFocus;
end;
